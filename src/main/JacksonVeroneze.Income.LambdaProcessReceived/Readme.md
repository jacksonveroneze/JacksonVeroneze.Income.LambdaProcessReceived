...
Execute unit tests
```
    cd "JacksonVeroneze.Income.LambdaProcessReceived/test/JacksonVeroneze.Income.LambdaProcessReceived.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "JacksonVeroneze.Income.LambdaProcessReceived/src/JacksonVeroneze.Income.LambdaProcessReceived"
